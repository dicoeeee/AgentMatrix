...
function driverTemplate() {
  return [
    ...
    "",
    "AgentMatrix core records deterministic Run Trace boundaries automatically. Record only compact platform summaries such as subagent invocation, checker shard counts, notable command summaries, or Stage Log links.",
